...
@DisplayName("Testes do gerenciador")
public class GerenciadorTest {
    ...
    @Test
    @Tag("cria")
    @DisplayName("Criacao de tarefa com campos nulos")
    ...
    @Test
    @Tag("atualiza")
    @DisplayName("Atualizacao de tarefa valida")
    ...
    @Test
    @Tag("atualiza")
    @DisplayName("Atualizacao de tarefa com campos nulos")
    ...
    @Test
    @Tag("atualiza")
    @DisplayName("Atualizacao de tarefa com campo invalido")
    ...
    @DisplayName("Exclusao de tarefa passando null")
    ...
    @Test
    @Tag("exclui_exception")
    @DisplayName("Exclusao de tarefa passando indice fora do range")
